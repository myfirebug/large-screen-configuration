export const echartsConfig = {
    ...
    [
      {
        ...
        list: [
          ...
          },
          {
            ...
            required: false,
            placeholder: "",
            relationFields: "xAxisSplitLineShow",
            relationValues: "true",
            options: [
              { code: "solid", name: "实线" },
              { code: "dashed", name: "虚线" },
    ...
    [
      {
        ...
        list: [
          ...
          },
          {
            ...
            required: false,
            placeholder: "",
            relationFields: "yAxisSplitLineShow",
            relationValues: "true",
            options: [
              { code: "solid", name: "实线" },
              { code: "dashed", name: "虚线" },
  ...
  seriesItemStyle: [
    {
      ...
      list: [
        ...
        },
        {
          componentName: "InputNumber",
          label: "线宽",
          name: "seriesItemStyleColorBorderWidth",
          required: false,
          min: 0,
          placeholder: "",
          addonAfter: "px",
        },
        {
          componentName: "InputNumber",
          label: "圆角",
          name: "seriesItemStyleColorBorderRadius",
          required: false,
          min: 0,
          placeholder: "",
          addonAfter: "px",
  ...
  emphasisValue: {
    ...
    emphasisLabelFontSize: 12,
    emphasisLabelColor: "",
    emphasisLabelFontWeight: "normal",
        ...
        [
          {
            ...
            list: [
              ...
              },
              {
                componentName: "InputNumber",
                label: "水平偏移距离",
                name: "emphasisStyleShadowOffsetX",
                required: false,
                min: 0,
                placeholder: "",
              },
              {
                componentName: "InputNumber",
                label: "垂直偏移距离",
                name: "emphasisStyleShadowOffsetY",
                required: false,
                min: 0,
                placeholder: "",
              },
